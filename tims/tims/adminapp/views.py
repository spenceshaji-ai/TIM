...
from adminapp.models import Enquiry, FollowUp
from adminapp.forms import EnquiryForm,FollowUpForm
from adminapp.models import Admission
from adminapp.forms import AdmissionForm
from adminapp.models import Course,Batch,FacultyAssignment,Assignstudent
from faculty.models import TrainingSession,FacultyDailyReport,StudentAttendance
from django.contrib.auth import get_user_model
User = get_user_model()
from adminapp.forms import CourseForm,BatchForm,FacultyAssignmentForm,AssignstudentForm,CertificateForm
from django.contrib import messages
